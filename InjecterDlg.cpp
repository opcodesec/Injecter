// InjecterDlg.cpp : implementation file
//
...
CInjecterDlg::CInjecterDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CInjecterDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CInjecterDlg)
...
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CInjecterDlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CInjecterDlg, CDialog)
	//{{AFX_MSG_MAP(CInjecterDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
